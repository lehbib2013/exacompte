package com.exacompte.exacaudt.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ExacAudit");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ExacAudit");
        ...
        config.getMapConfigs().put("com.exacompte.exacaudt.domain.*", initializeDomainMapConfig(jHipsterProperties));
